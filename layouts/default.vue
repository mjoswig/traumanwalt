        ...
        <div class="p-4 sm:p-8 wrapper flex flex-col w-full">
          ...
          <footer class="border-t flex flex-col pt-4 md:pt-8 w-full">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full mb-8 lg:mb-12">
              ...
              <div>
                <h3 class="text-lg mb-2">Für Mandanten</h3>
                <ul class="flex flex-col space-y-2">
                  <li><nuxt-link to="/login">Anmelden</nuxt-link></li>
        ...
        <div class="md:flex flex-wrap text-gray-700 w-full h-screen">
          <div class="w-full md:w-1/3 lg:w-1/5 p-4 shadow-lg">
            ...
            <ul class="admin-sidebar md:text-lg flex flex-col space-y-3 md:space-y-6 mt-3 md:mt-6" :class="{ 'hidden md:block': !showMobileMenu }">
              ...
              <li v-show="isClient">
                <nuxt-link to="/konto/mandant/mandate" class="flex items-center space-x-3" :class="{ 'font-bold': $route.path.startsWith('/konto/mandant/mandate') }">
              ...
              <li v-show="!isClient && (!trialExpired || hasSubscribed)">
                <nuxt-link to="/konto/anwalt/mandate" class="flex items-center space-x-3" :class="{ 'font-bold': $route.path.startsWith('/konto/anwalt/mandate') }">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-briefcase h-5 w-5 md:h-6 md:w-6" viewBox="0 0 16 16">
                    <path d="M6.5 1A1.5 1.5 0 0 0 5 2.5V3H1.5A1.5 1.5 0 0 0 0 4.5v8A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-8A1.5 1.5 0 0 0 14.5 3H11v-.5A1.5 1.5 0 0 0 9.5 1zm0 1h3a.5.5 0 0 1 .5.5V3H6v-.5a.5.5 0 0 1 .5-.5m1.886 6.914L15 7.151V12.5a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5V7.15l6.614 1.764a1.5 1.5 0 0 0 .772 0M1.5 4h13a.5.5 0 0 1 .5.5v1.616L8.129 7.948a.5.5 0 0 1-.258 0L1 6.116V4.5a.5.5 0 0 1 .5-.5"/>
                  </svg>
                  <span>Mandatsbörse</span>
                </nuxt-link>
              </li>
              <li>
                <nuxt-link to="/konto/einstellungen" class="flex items-center space-x-3" :class="{ 'font-bold': $route.path.startsWith('/konto/einstellungen') }">
