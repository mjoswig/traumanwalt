<template>
  <div>
          ...
          <header class="mb-8 md:mb-12">
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center space-x-8">
                ...
                <div class="lg:hidden" style="margin-top: 2px;">
                  ...
                  <svg v-show="showMobileMenu" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16" @click="showMobileMenu = false">
      ...
      <div v-show="!showPublicLayout">
        <div class="md:flex flex-wrap text-gray-700 w-full h-screen">
          <div class="w-full md:w-1/3 lg:w-1/5 p-4 shadow-lg">
            <div class="flex items-center justify-between">
              <nuxt-link class="w-44 md:w-56" to="/konto">
                <img class="w-44 md:w-56 h-auto" src="@/assets/images/traumanwalt-logo.png" />
              </nuxt-link>
              <div class="md:hidden" style="margin-top: 2px;">
                <svg v-show="!showMobileMenu" xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16" @click="showMobileMenu = true">
                  <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
                </svg>
                <svg v-show="showMobileMenu" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16" @click="showMobileMenu = false">
            ...
            <ul class="admin-sidebar md:text-lg flex flex-col space-y-3 md:space-y-6 mt-3 md:mt-6" :class="{ 'hidden md:block': !showMobileMenu }">
              ...
              <li v-show="!trialExpired || hasSubscribed">
                <nuxt-link to="/konto/profil" class="flex items-center space-x-3">
              ...
              <li v-show="!trialExpired || hasSubscribed">
                <nuxt-link to="/konto/kanzleiprofil" class="flex items-center space-x-3">
              ...
              <li v-show="!trialExpired || hasSubscribed">
                <nuxt-link to="/konto/nachrichten" class="flex items-center space-x-3">
              ...
              <li v-show="!trialExpired || hasSubscribed">
                <nuxt-link to="/konto/rechtstipps" class="flex items-center space-x-3">
              ...
              <li v-show="!trialExpired || hasSubscribed">
                <nuxt-link to="/konto/bewertungen" class="flex items-center space-x-3">
          ...
          <div class="w-full md:w-2/3 lg:w-4/5">
            <div v-show="!trialExpired && !hasSubscribed" class="text-orange-700 px-4 text-sm sm:text-base sm:px-8 py-3 md:text-center" style="background-color: rgb(255, 245, 236);">
            ...
            <div v-show="trialExpired && !hasSubscribed" class="bg-red-100 text-red-700 px-4 text-sm sm:text-base sm:px-8 py-3 sm:text-center">
            ...
            <div v-show="$route.query.subscribed && hasSubscribed" class="bg-green-100 text-green-700 px-4 text-sm sm:text-base sm:px-8 py-3 sm:text-center">
    ...
    <div v-if="isLoading" class="flex items-center justify-center h-screen w-screen">
      <LoadingIndicator />
    </div>
  </div>
</template>
