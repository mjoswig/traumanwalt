    ...
    <div class="flex flex-col space-y-8 lg:flex-row lg:space-x-8 lg:space-y-0">
      <article class="flex flex-col space-y-6 md:space-y-8 w-full lg:w-2/3">
        <section>
          ...
          <div v-if="profile.about" class="mt-4" v-html="profile.about"></div>
        </section>
        <hr />
        <section class="flex flex-col space-y-4 md:space-y-6">
          ...
          <div>
            ...
            <div v-if="legalFields.length" class="flex flex-wrap text-sm md:text-base">
              <span class="break-keep bg-gray-100 px-2 py-1 rounded-md mr-1 my-1 md:mr-2 md:my-2" v-for="(legalField, index) in legalFields" :key="index">
          ...
          <div>
            ...
            <div v-if="languages.length" class="flex flex-wrap text-sm md:text-base">
              <span class="break-keep bg-gray-100 px-2 py-1 rounded-md mr-1 my-1 md:mr-2 md:my-2" v-for="(language, index) in languages" :key="index">
                {{ language.name }}
              </span>
            </div>
          </div>
