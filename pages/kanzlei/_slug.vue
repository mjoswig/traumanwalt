<template>
  <div class="-mt-4">
    <div class="relative bg-cover p-4 md:p-8 flex flex-col items-center justify-center space-y-3 md:space-y-6 rounded-md mb-8 md:mb-12" :style="`background-image: url(${require('@/assets/images/traumanwalt-profile-cover.jpeg')});`">
      ...
      <div v-if="lawFirm.linkedin_url || lawFirm.xing_url || lawFirm.facebook_url || lawFirm.twitter_url || lawFirm.instagram_url || lawFirm.youtube_url" class="z-10 flex justify-center space-x-4 py-2 md:py-0">
        <a v-if="lawFirm.linkedin_url" class="text-white hover:text-white" :href="lawFirm.linkedin_url" target="_blank" rel="nofollow">
        ...
        <a v-if="lawFirm.xing_url" class="text-white hover:text-white" :href="lawFirm.xing_url" target="_blank" rel="nofollow">
        ...
        <a v-if="lawFirm.facebook_url" class="text-white hover:text-white" :href="lawFirm.facebook_url" target="_blank" rel="nofollow">
        ...
        <a v-if="lawFirm.twitter_url" class="text-white hover:text-white" :href="lawFirm.twitter_url" target="_blank" rel="nofollow">
        ...
        <a v-if="lawFirm.instagram_url" class="text-white hover:text-white" :href="lawFirm.instagram_url" target="_blank" rel="nofollow">
        ...
        <a v-if="lawFirm.youtube_url" class="text-white hover:text-white" :href="lawFirm.youtube_url" target="_blank" rel="nofollow">
        ...
        <div class="flex flex-col space-y-4 md:space-y-6" v-if="phoneNumber || lawFirm.contact_email || lawFirm.website_url">
          ...
          <div class="flex flex-col space-y-2">
            ...
            <div v-if="lawFirm.website_url" class="flex space-x-2">
              ...
              <a :href="lawFirm.website_url" rel="nofollow" target="_blank">{{ websiteLinkTitle }}</a>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    websiteLinkTitle() {
      if (!this.lawFirm.website_url) return null
      return this.lawFirm.website_url.replace(/^(?:https?:\/\/)?(?:www\.)?/i, '').replace(/\/+$/, '')
    },
    lawFirmColleagues() {
