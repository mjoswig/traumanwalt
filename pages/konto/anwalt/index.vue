    ...
    <div class="grid xl:grid-cols-2 gap-4 mb-4">
      ...
      <AccountSection heading="Wie gefällt Ihnen Traumanwalt?">
        <div class="border-l-4 pl-2">
          <p class="mb-2">„Vielen Dank für Ihr Interesse an Traumanwalt. Wir möchten Ihnen mit unserer Plattform helfen, Ihre Kanzlei zu vermarkten und online neue Mandate zu generieren.</p>
