      ...
      <section class="w-full lg:w-2/3">
        ...
        <div class="grid grid-cols gap-2 md:gap-4">
          ...
          <div>
            ...
            <p class="md:text-lg">Sie bezahlen das Beratungshonorar in Höhe von {{ new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(legalService.price) }} in Vorkasse. Sie können mittels Visa, Mastercard, Apple Pay, Google Pay, PayPal, giropay, Sofort oder Klarna bezahlen.</p>
          </div>
          <div>
